        ...
        <div className="container py-5 ">
            ...
            <div className="container">
                <Row gutter={[12, 12]} >
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="400" >
                        <Card hoverable className="rounded-5 shadow ">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="500" >
                        <Card hoverable className="rounded-5 shadow ">
                    ...
                    <Col xs={24} sm={24} md={12} lg={8} data-aos="fade-up" data-aos-delay="600" >
                        <Card hoverable className="rounded-5 shadow ">
